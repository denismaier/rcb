...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt">
  <title>JDS JATS-Basisvalidierung (Demo)</title>
  ...
  <pattern id="doi-format">
    <rule context="article/front/article-meta/article-id[@pub-id-type='doi']">
      ...
      <assert test="starts-with(., 'https://doi.org/10.5555/jds.')">
        Ungültiger DOI: <value-of select="." />. DOI muss mit 'https://doi.org/10.5555/jds.' beginnen.
      </assert>
      <!-- Prüft, dass der DOI auf eine Zahl endet (Jahreszahl.Nummer) -->
      <assert test="matches(., 'https://doi.org/10.5555/jds.[0-9]+\.[0-9]+$')">
        Ungültiger DOI: <value-of select="." />. DOI muss auf eine Zahl enden (z.B. https://doi.org/10.5555/jds.2026.1).
      </assert>
    </rule>
  </pattern>
